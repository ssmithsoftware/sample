...
export default class FormElement extends CustomElement {
  ...
  connectedCallback () {
    ...
    this.disconnectedCallbacks.push(() => this.form?.removeEventListener('submit', onSubmit))
  }
  ...
  setResponse ({ error = false, message = 'Something went wrong' } = {}) {
    ...
    setTimeout(() => {
      if (this.#responseSpan?.textContent) this.#responseSpan.textContent = null
    }, 3000)
  }
