...
const baseTemplates = /** @type {const} */ ([
	'elements',
	'modals',
	'routes',
	'svgs'
...
export function template(id) {
	...
	if (!(template instanceof HTMLTemplateElement))
		throw new Error(
			`${elementMissing({ selectors: `template#${id}` })} in document head`
		)
